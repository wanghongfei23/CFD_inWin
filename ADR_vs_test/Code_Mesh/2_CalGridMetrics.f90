...
!real:: XYeta_xi(Nx,Ny),  XetaY_xi(Nx,Ny),  XYxi_eta(Nx,Ny),  XxiY_eta(Nx,Ny) !> For SCMM
!real:: XYeta_xi_j(Nx),   XetaY_xi_j(Nx),   XYxi_eta_i(Ny),   XxiY_eta_i(Ny)  !> For SCMM
!real:: Area
!
!    !==================================!
!    !           SP Metrics             !
