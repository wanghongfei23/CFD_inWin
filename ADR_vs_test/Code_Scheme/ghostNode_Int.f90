...
Subroutine linear_O5 ( nVar, var_In, var_Out )
use Parameters
implicit none
...
real,INTENT(IN ):: var_In(nVar,Order) !> optimalģ��
...
integer:: iVar
    ...
    Do iVar=1,nVar
        fp=var_In(iVar, 1:5)
        call  Linear_5thi( fh , fp )
        var_Out(iVar) = fh
    End Do
End Subroutine
    
Subroutine TCNS_Cong_O5 ( nVar, var_In, var_Out )
use Parameters
implicit none
integer,parameter:: Order = 5            !> Accuracy
integer,parameter:: nSub = (Order+1)/2   !> Number of sub-stencils
...
integer:: iVar
    ...
    Do iVar=1,nVar
        fp=var_In(iVar, 1:5)
        call TCNS_Cong_5th( fh , fp )
        var_Out(iVar) = fh
    End Do
    End Subroutine
    
Subroutine TCNS_O5 ( nVar, var_In, var_Out )
use Parameters
implicit none
integer,parameter:: Order = 5            !> Accuracy
integer,parameter:: nSub = (Order+1)/2   !> Number of sub-stencils
