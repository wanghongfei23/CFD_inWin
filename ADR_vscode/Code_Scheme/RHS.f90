...
real(kind=8):: StencilR(nVar,OInt)
    ...
    ElseIF( OInt == 5 )Then
        ...
        ! call TCNS_ASF103_O5_ai ( nVar, StencilL, primL )
        ! call TCNS_ASF102_var_01_O5_ai ( nVar, StencilL, primL )
        ! call TCNS_ASF103_var_01_O5_ai ( nVar, StencilL, primL )
        call TCNS_ASF203_O5_ai ( nVar, StencilL, primL )
    ElseIF( OInt == 7 )Then
